...
public class ItemSavingTest {
    ...
    public void testHelmet() {
        ...
        Helmet helmet2 = new Helmet(new BasicItemView(), map);
    ...
    public void testChestPiece() {
        ...
        ChestPiece helmet2 = new ChestPiece(new BasicItemView(), map);
        assertEquals(map.getJson(), helmet2.getStructuredMap().getJson());
    }
    ...
    public void testLeggings() {
        ...
        Leggings helmet2 = new Leggings(new BasicItemView(), map);
        assertEquals(map.getJson(), helmet2.getStructuredMap().getJson());
    }
    ...
    public void testBoots() {
        ...
        Boots helmet2 = new Boots(new BasicItemView(), map);
        assertEquals(map.getJson(), helmet2.getStructuredMap().getJson());
    }
    ...
    public void testGloves() {
        ...
        Gloves helmet2 = new Gloves(new BasicItemView(), map);
        assertEquals(map.getJson(), helmet2.getStructuredMap().getJson());
    }
    ...
    public void testProjectile() {
        ...
        Projectile helmet2 = new Projectile(new BasicItemView(), map);
        assertEquals(map.getJson(), helmet2.getStructuredMap().getJson());
    }
